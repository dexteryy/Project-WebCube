  ...
  const addReactEntryActions = [
    {
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react/main/containers/App.jsx'
      ),
    },
    {
      type: 'add',
  ...
  const addReactRouterEntryActions = [
    {
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-router/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-router/routes.jsx'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-router/main/containers/App.jsx'
      ),
    },
    {
      type: 'add',
  ...
  const addReactReduxEntryActions = [
    {
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux/main/reducers/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux/main/actions/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux/main/containers/App.jsx'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux/main/containers/Home.jsx'
      ),
    },
    {
      type: 'add',
  ...
  const addReactReduxRouterEntryActions = [
    {
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/routes.jsx'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/main/reducers/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/main/actions/index.js'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/main/containers/App.jsx'
      ),
    },
    {
      type: 'add',
      ...
      templateFile: path.join(
        modulePath,
        'templates/app/entries/react-redux-router/main/containers/Home.jsx'
      ),
    },
    {
      type: 'add',
